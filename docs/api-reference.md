...
homebot:__e2e_ping                    homebot:__e2e_trigger_fallback
homebot:__e2e_trigger_upstream_error  homebot:add-message
homebot:append-renderer-log           homebot:automation:image:generate
homebot:browse-status                 homebot:capture-logs
...
homebot:mcp-toggle-server             homebot:message
