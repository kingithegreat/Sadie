...
**Preload methods (184)** — `window.electron`
...
mediaAdvance                    mediaAncientPathwaysEpisodes    mediaAncientPathwaysRun         mediaAncientPathwaysStatus
mediaApprove                    mediaCreate                     mediaDelete                     mediaFfmpegSetup
mediaFfmpegStatus               mediaList                       mediaMarkPublished              mediaParseFeed
...
**IPC channels, renderer → main (134)**
...
homebot:media:advance                    homebot:media:ancient-pathways-episodes
homebot:media:ancient-pathways-run       homebot:media:ancient-pathways-status
