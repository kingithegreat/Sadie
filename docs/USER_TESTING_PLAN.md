...
**Owner:** Aden. **Reconciled:** 2026-09-19, from `origin/main` at `779487e` and live GitHub PR/issue state. The prior status pass in PR #385 was based on an older main and conflicted; this document supersedes it.
...
| REL-3.1 | **Dead IPC channels:** `setAlwaysOnTop` and `licenseValidate` | Removed or wired to UI | PR #388 |
