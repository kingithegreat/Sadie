...
$BLOCKED_DIRECTORIES = @(
    ...
    # Single-quoted on purpose: inside double quotes PowerShell interpolates
    # "$Recycle" as an (undefined) variable, turning this entry into "C:\.Bin"
    # and silently unblocking the Recycle Bin.
    'C:\$Recycle.Bin'
)
