...
const signatures: Record<string, string[]> = {
  ...
  'movie:run': ['object'], 'movie:list-projects': [], 'movie:colab:list': ['object'],
  'movie:colab:cancel': ['object'], 'movie:colab:retry': ['object'], 'storyboard:create': ['object'], 'storyboard:list': [],
