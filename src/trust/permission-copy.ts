...
export const KNOWN_PERMISSION_COPY: Record<string, PermissionCopy> = {
  ...
  media_generate_storyboard_clip: { label: 'Generate storyboard clip', detail: 'Generate a paid per-second Veo video clip for an individual shot using your connected Google key.' },
