...
|---|---|---|---|
| YouTube desktop connection — owner OAuth and channel status | claude/youtube-desktop-connection | Building — Codex 2026-09-09 | Isolated fresh-main worktree `.kilo/worktrees/codex-youtube-connection`. Existing Connections screen, desktop JSON import, system-browser PKCE/state login, encrypted credentials and read-only channel status. No uploads or publishing. Preserve separately claimed speech/export/lazy-runtime work. Notion claim: https://app.notion.com/p/3d6829ebf7be81f3a9f2c96656655dc9. |
