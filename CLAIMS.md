...
|---|---|---|---|
| HB-M2 prerequisite — durable movie image outputs | claude/studio-movie-artifacts | Claimed — Codex 2026-09-09 | Fresh main `19535cb` in `.kilo/worktrees/codex-movie-artifacts`. Save and validate actual shot images; reject empty/corrupt image results through router, runner and cached/deferred states. Prove controlled transport and reachable Electron output; no credential/spending or video-QC claim. Speech privacy and module controls remain separately owned. |
