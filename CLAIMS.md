...
|---|---|---|---|
| HB-M2 — Studio controls final startup regression | claude/studio-module-controls | Building final fix — Codex 2026-09-09 | PR #269 auto-merge paused. The hardware toast covers the registered Studio button for about 9.6 seconds; actual Electron regression fails at toast top 44px versus header bottom 169px. Keep notifications below the responsive header, prove actual navigation, and recheck the recorded baseline. Existing bounded-controls evidence is retained below. |
...
| Feature | Branch | Status | Notes |
|---|---|---|---|
| ~~HB-M2 — reachable Studio module controls~~ | claude/studio-module-controls | Implementation verified; build claim released — Codex 2026-09-09 | PR #269. All six initial remote gates passed, then image-artifact main 4b9cdf2 was integrated. Final combined local checkpoint: 3,867 widget tests plus six real Electron module/Studio/movie cases, no retries. Prior full Electron 50 and root 227 passed. Typechecks/build/lint/docs/import checks pass. UI disable, tool/IPC denial, saved restart choice, retained files and one-copy restoration verified. Evidence: docs/STUDIO_MODULE_CONTROLS.md. Current CI/merge status and integration ownership: https://app.notion.com/p/3d5829ebf7be814eaccceeaaa9b1e565. Full M2/media acceptance remains open. |
