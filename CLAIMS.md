...
|---|---|---|---|
| ~~HB-M2 prerequisite — durable movie image outputs~~ | claude/studio-movie-artifacts | Implementation verified; claim released — Codex 2026-09-09 | Four image adapters save readable shot images; router and runner reject unusable results and corrupt cached/deferred images. Windows: 3,850 widget + 226 root tests, static/build/docs checks and four actual Electron image/privacy tests pass. Evidence: `tasks/movie-image-output.md`. Remote gates/merge pending at this checkpoint; no live AI provider, video QC or full M2 claim. |
| HB-M2 — reachable Studio module controls | claude/studio-module-controls | Claimed in another session — Codex 2026-09-09 | Live Notion ledger confirms Modules screen and persisted Studio enable/disable are separately owned. Preserve that worktree and contribution changes. |
...
Movie/image online consent is **merged as #266**, verified 2026-09-09 local
at `19535cb`; main exactly matches tested head `bbb5202`. The prior local and
remote evidence remains in `tasks/movie-provider-privacy.md` and Notion.
